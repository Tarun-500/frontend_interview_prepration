...
### 30. Number of Longest Increasing Subsequences - Given an integer array `nums`, return the number of longest increasing subsequences.
...
# 🟢🟢🟢 EASY LEVEL 🟢🟢🟢
### 31. Longest Continuous Increasing Subsequence - Given an unsorted array of integers `nums`, return the length of the longest continuous increasing subsequence (i.e., subarray).  
...
The longest continuous increasing subsequences are:
...
|-------|-------|-------------|
| ⚪ TRIVIAL | `⚪ TRIVIAL` | One-liner, direct method call |
| 🟢 VERY EASY | `🟢 VERY EASY` | Basic syntax, minimal logic |
| 🟢 EASY | `🟢 EASY` | Straightforward, 1-2 steps |
| 🟡 MEDIUM | `🟡 MEDIUM` | Requires thought and optimization |
| 🔴 HARD | `🔴 HARD` | Complex logic, multiple constraints |
| ⚫ VERY HARD | `⚫ VERY HARD` | Expert level, rare in interviews |
